...
if __name__ == '__main__':
    ...
    #parser.add_argument('--video', type=str, default="datasets/test_data/Nancy_Sinatra/Nancy_Sinatra_Video.mp4")
    #parser.add_argument('--video', type=str, default="datasets/test_data/Alan_Ball/Alan_Ball_Video.mp4")
    #parser.add_argument('--video', type=str,default="datasets/test_data/Manuel_Pellegrini/Manuel_Pellegrini_Video.mp4")
    #parser.add_argument('--video', type=str, default="datasets/test_data/Marina_Silva/Marina_Silva_Video.mp4")
    #parser.add_argument('--video', type=str, default="datasets/test_data/Peter_Gilmour/Peter_Gilmour_Video.mp4")

    # those that are not in training
    #parser.add_argument('--video', type=str, default="datasets/test_data/Al_Pacino/Al_Pacino_Video.mp4")
    #parser.add_argument('--video', type=str, default="datasets/test_data/Maria_Shriver/Maria_Shriver_Video.mp4")
